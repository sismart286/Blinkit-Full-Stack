...
const CheckoutPage = () => {
  ...
  const handleCashOnDelivery = async () => {
    console.log("addressList[selectedAddress]: ", addressList[selectedAddress]);
    console.log(
      "cartItemsList, notDiscountTotalPrice, totalPrice, totalQty: ",
      cartItemsList,
      notDiscountTotalPrice,
      totalPrice,
      totalQty
  ...
  const handleOnlinePayment = async () => {
    try {
      ...
      // console.log("result ", stripe.redirectToCheckout({ sessionId: responseData.id }));
