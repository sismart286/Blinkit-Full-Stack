...
const EditCategory = ({ close, fetchData, data: CategoryData }) => {
  ...
  const handleUploadCategoryImage = async (e) => {
    ...
    console.log("handleUploadCategoryImage: " + file);
        ...
        <form action="" className="my-3 grid gap-2" onSubmit={handleSubmit}>
          <div className="grid gap-1">
            ...
            <input
              ...
              className="bg-blue-50 p-2 border border-blue-100 focus-within:border-orange-400 outline-none rounded"
            />
          </div>
          <div className="grid gap-1">
            <p>Image</p>
              ...
              <label htmlFor="uploadCategoryImage">
                <div
                  className={`${
                    !data.name
                      ? "bg-gray-400"
                      : "border-orange-400 hover:bg-orange-400"
