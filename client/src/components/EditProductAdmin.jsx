            ...
            <form action="" className="grid gap-4" onSubmit={handleSubmit}>
              <div className="grid gap-1">
                ...
                <input
                  ...
                  required
                  className="bg-blue-50 p-2 outline-none border focus-within:border-orange-400 rounded"
                />
              </div>
              <div className="grid gap-1">
                ...
                <textarea
                  ...
                  required
                  rows={3}
                  className="bg-blue-50 p-2 outline-none border focus-within:border-orange-400 rounded resize-none"
                />
              </div>
              <div>
              ...
              <div
                ...
                className=" hover:bg-orange-500 bg-white py-1 px-3 w-32 text-center font-semibold border border-orange-500 hover:text-neutral-900 cursor-pointer rounded"
              >
                Add Fields
              </div>

              <button className="bg-orange-400 hover:bg-orange-500 py-2 rounded font-semibold">
                Update Product
              </button>
            </form>
          </div>
