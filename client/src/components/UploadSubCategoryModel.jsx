        ...
        >
          <div className="grid gap-1">
            ...
            <input
              ...
              type="text"
              className="p-3 bg-blue-50 border outline-none focus-within:border-orange-400 rounded"
            />
          </div>
          <div className="grid gap-1">
            <p>Image</p>
            <div className="flex flex-col lg:flex-row items-center gap-3">
              ...
              <label htmlFor="uploadSubCategoryImage">
                <div className="px-4 py-1 border border-orange-600 text-orange-600 rounded hover:bg-orange-400 hover:text-neutral-900 cursor-pointer">
                  Upload Image
                </div>
                <input
                  type="file"
          ...
          <div className="grid gap-1">
            ...
            <div className="border focus-within:border-orange-500 rounded">
              {/**display value*/}
